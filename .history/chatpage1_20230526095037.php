...
<body>
    <div class="wrapper">
        <section class="users">
            ...
            <input style="display:hidden" name="outgoing_id" type="text" value="<?php echo $_SESSION['user_id']?>">    
            <input display="hidden" name="incoming_id" type="text" value="<?php echo $user_id ?>">    
