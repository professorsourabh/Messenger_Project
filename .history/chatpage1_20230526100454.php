...
<body>
    <div class="wrapper">
        <section class="users">
            ...
            <input style="display:none" name="outgoing_id" type="text" value="<?php echo $_SESSION['user_id']?>">    
            <input display="display:none" name="incoming_id" type="text" value="<?php echo $user_id ?>">    
