...
<body>
    <div class="container col-md-4 col-lg-3 border border-warning rounded">
     ...
     <strong>Success!</strong><?php  echo $_SESSION['msg']; unset($_SESSION['msg']); ?></a>
        </div>
        <?php
            ...
            <form id="login-form" onsubmit="validateForm(event)" enctype="multipart/form-data" method="post" action="signup.php">
                ...
                <div class="link">Already signed up? <a href="http://localhost/chat_project/loginpage.php">Login now</a></div>
            </form>
        </div>
    </div>
